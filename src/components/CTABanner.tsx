...
export default function CTABanner({ headline, subtext }: CTABannerProps) {
  const { t } = useLanguage();
  const displayHeadline = headline || t.cta.defaultHeadline;
  const displaySubtext = subtext || t.cta.defaultSubtext;
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-black via-brand-dark-gray to-brand-black py-24">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <ScrollReveal>
          ...
          <p className="mt-4 text-lg text-gray-400">{displaySubtext}</p>
        </ScrollReveal>
        <motion.div
